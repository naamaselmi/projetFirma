...
public class MarketplaceController implements Initializable {
    ...
    @FXML
    private ImageView imgLocations;

    @FXML
    private ImageView imgCommandes;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try {
            ...
            setImage(imgLocations, "/image/i5.png");
            setImage(imgCommandes, "/image/i6.png");
        } catch (Exception e) {
    ...
    void handleEquipements(ActionEvent event) {
        navigateTo(event, "/GestionMarketplace/marketplace/GUI/views/EquipementView.fxml");
    }

    @FXML
    void handleFournisseurs(ActionEvent event) {
        navigateTo(event, "/GestionMarketplace/marketplace/GUI/views/FournisseurView.fxml");
    }

    @FXML
    void handleTerrains(ActionEvent event) {
        navigateTo(event, "/GestionMarketplace/marketplace/GUI/views/TerrainView.fxml");
    }

    @FXML
    void handleVehicules(ActionEvent event) {
        navigateTo(event, "/GestionMarketplace/marketplace/GUI/views/VehiculeView.fxml");
    }

    @FXML
    void handleLocations(ActionEvent event) {
        navigateTo(event, "/GestionMarketplace/marketplace/GUI/views/LocationAdminView.fxml");
    }

    @FXML
    void handleCommandes(ActionEvent event) {
        navigateTo(event, "/GestionMarketplace/marketplace/GUI/views/CommandeAdminView.fxml");
    }
}
