...
public class ClientDashboardController implements Initializable, CartService.CartChangeListener {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        // Default to Accueil view
        handleAccueil(new ActionEvent(btnAccueil, null));
    }
    ...
    private void loadCartPanel() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/GestionMarketplace/marketplace/GUI/views/CartPanelView.fxml"));
    ...
    private void loadRentalsPanel() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/GestionMarketplace/marketplace/GUI/views/RentalsPanelView.fxml"));
    ...
    public void navigateToPayment() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/GestionMarketplace/marketplace/GUI/views/PaymentView.fxml"));
    ...
    void handleAccueil(ActionEvent event) {
        ...
        loadView("/GestionMarketplace/marketplace/GUI/views/ClientAccueilView.fxml");
    }
    ...
    void handleEvenement(ActionEvent event) {
        ...
        loadView("/GestionEvenement/FrontContent.fxml");
    }

    @FXML
    void handleTechnicien(ActionEvent event) {
        setActiveButton(btnTechnicien, lblTechnicien, iconTechnicien);
        loadView("/GestionTechnicien/ListeDesTechniciensfront.fxml");
    }
    ...
    private void loadMarketplaceView() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/GestionMarketplace/marketplace/GUI/views/ClientMarketplaceView.fxml"));
            Parent view = loader.load();
    ...
    void handleDeconnecter(ActionEvent event) {
        try {
            ...
            Parent loginView = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("/LoginApplication.fxml")));
