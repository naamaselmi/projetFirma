...
public class AdminDashboardController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        // Default View – open Accueil dashboard
    ...
    void handleAccueil(ActionEvent event) {
        ...
        loadView("/GestionMarketplace/marketplace/GUI/views/AdminAccueilContent.fxml");
    }

    @FXML
    void handleEvenement(ActionEvent event) {
        setActiveButton(btnEvenement);
        loadView("/GestionEvenement/DashboardContent.fxml");
    }
    ...
    void handleMarketplace(ActionEvent event) {
        ...
        loadView("/GestionMarketplace/marketplace/GUI/views/MarketplaceView.fxml");
    }

    @FXML
    void handleTechnicien(ActionEvent event) {
        setActiveButton(btnTechnicien);
        loadView("/GestionTechnicien/ListeDesTechniciens.fxml");
    }
    ...
    void handleDeconnecter(ActionEvent event) {
        try {
            ...
            Parent loginView = FXMLLoader
                    .load(Objects.requireNonNull(getClass().getResource("/LoginApplication.fxml")));
