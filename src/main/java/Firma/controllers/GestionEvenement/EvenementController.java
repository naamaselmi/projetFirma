...
public class EvenementController {
    ...
    @FXML private Label          createIAStatusLabel;
    ...
    @FXML private Label          modifyIAStatusLabel;
    ...
    @FXML void genererImageIACreate(ActionEvent event) { formHelper.genererImageIACreate(); }
    @FXML void genererImageIAModify(ActionEvent event) { formHelper.genererImageIAModify(); }
    ...
    @FXML void goToAccueil(ActionEvent event)     {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/GestionEvenement/Accueil.fxml"));
            Parent root = loader.load();
            Stage stage = (Stage) ((javafx.scene.Node) event.getSource()).getScene().getWindow();
            stage.setScene(new Scene(root));
            stage.setMaximized(true);
            stage.setTitle("FIRMA - Accueil");
            stage.show();
        } catch (Exception ex) {
            System.err.println("Erreur navigation Accueil : " + ex.getMessage());
            ex.printStackTrace();
        }
    }
    ...
    Label          getCreateIAStatusLabel() { return createIAStatusLabel; }
    ...
    Label          getModifyIAStatusLabel() { return modifyIAStatusLabel; }
