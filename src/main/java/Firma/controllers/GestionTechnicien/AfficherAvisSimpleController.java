...
import Firma.entities.GestionTechnicien.Avis;
...
public class AfficherAvisSimpleController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        System.out.println("✅ AfficherAvisSimpleController initialisé");
                ...
                idUtilisateurConnecte = (SessionManager.getInstance().getUtilisateur() != null ? SessionManager.getInstance().getUtilisateur().getId() : 0);
    ...
    private void modifierAvis(Avis avis) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/GestionTechnicien/ModifierAvis.fxml"));
